...
my $program = "/Users/brandon/Downloads/bio/preprocess/tools/muscle_3.8.1551/muscle";
my $aa_file = "";
if(!exists($params{"-a"})) {    
    if(!exists($params{"-p"}))          {   $program = "/Users/brandon/Downloads/bio/preprocess/tools/muscle_3.8.1551/muscle";        }
    ...
    else                                {   $program = "/Users/brandon/Downloads/bio/preprocess/tools/muscle_3.8.1551/muscle";        }
} else                                  {   $program = "";          
                                        $aa_file = $params{"-a"};   
                                        if(!-e $aa_file) 
